...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rcMaskInput = __webpack_require__(3);
	
	var _rcMaskInput2 = _interopRequireDefault(_rcMaskInput);
	...
	var Demo = function (_React$Component) {
	  ...
	  Demo.prototype.render = function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(_rcMaskInput2.default, null),
	      _react2.default.createElement(
	        'label',
	        null,
	        '银行卡号:'
	      ),
	      _react2.default.createElement(_rcMaskInput2.default, { group: [4, 4, 4, 4, 3] }),
	      _react2.default.createElement(
	        'label',
	        null,
	        '信用卡:'
	      ),
	      _react2.default.createElement(_rcMaskInput2.default, { group: [4, 4, 4, 4] })
	    );
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MaskInput = __webpack_require__(5);
	
	var _MaskInput2 = _interopRequireDefault(_MaskInput);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = _MaskInput2.default; // export this package's api
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MaskInput = function (_React$Component) {
	  _inherits(MaskInput, _React$Component);
	  ...
	  MaskInput.prototype.componentWillMount = function componentWillMount() {
	    var _this2 = this;
	
	    //process some properties
	    this.groupByArray = this.props.group.map(function (item, index) {
	      return _this2.props.group.slice(0, index + 1).reduce(function (mem, current) {
	        return mem + current;
	      });
	    });
	  ...
	  MaskInput.prototype.smartFormat = function smartFormat(position, value) {
	    ...
	    first.split('').forEach(function (code, index) {
	    ...
	    second.split('').forEach(function (code, index) {
	  ...
	  MaskInput.prototype.handleChange = function handleChange(e) {
	    var target = e.target,
	  ...
	  MaskInput.prototype.render = function render() {
	    return _react2.default.createElement('input', { ref: 'maskedInput', onChange: this.handleChange.bind(this), value: this.state.formatedValue });
	  };
	...
	MaskInput.propTypes = {
	  acceptType: _react2.default.PropTypes.oneOf(['number', 'all']),
